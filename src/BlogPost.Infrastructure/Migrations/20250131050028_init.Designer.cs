...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlogPost.Domain.Aggregates.Root.Blog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("BlogPost.Domain.Aggregates.Root.Category", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("BlogPost.Domain.Aggregates.Root.EventLogs", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("BlogPost.Domain.Aggregates.Root.Blog", b =>
                {
                    b.OwnsMany("BlogPost.Domain.Aggregates.Entities.BlogImage", "Images", b1 =>
                        {
                            b1.Property<long>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("bigint");
                    ...
                    b.OwnsOne("BlogPost.Domain.Aggregates.ValueObjects.UrlHandle", "UrlHandle", b1 =>
                        {
                            b1.Property<long>("BlogId")
                                .HasColumnType("bigint");
                    ...
                    b.OwnsOne("BlogPost.Domain.Aggregates.ValueObjects.Author", "Author", b1 =>
                        {
                            b1.Property<long>("BlogId")
                                .HasColumnType("bigint");
                    ...
                    b.OwnsMany("BlogPost.Domain.Aggregates.ValueObjects.BlogPostCategory", "CategoryIds", b1 =>
                        {
                            b1.Property<long>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("bigint");
                            ...
                            b1.ToTable("BlogPostCategories", (string)null);

                            b1.WithOwner()
                                .HasForeignKey("BlogId");

                            b1.HasOne("BlogPost.Domain.Aggregates.Root.Category", null)
                                .WithMany()
                    ...
                    b.OwnsOne("BlogPost.Domain.Aggregates.ValueObjects.FeaturedImage", "FeaturedImage", b1 =>
                        {
                            b1.Property<long>("BlogId")
                                .HasColumnType("bigint");
            ...
            modelBuilder.Entity("BlogPost.Domain.Aggregates.Root.EventLogs", b =>
                {
                    b.OwnsOne("BlogPost.Domain.Aggregates.Enumerations.EventType", "EventType", b1 =>
                        {
